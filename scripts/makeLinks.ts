...
const playerSpellIds = [
  ...
  197895, 388509, 467307, 1239442, 328670, 1268807, 1277302, 388682, 1280297, 1243155, 1260511,
  443591, 1270621, 115294, 434774, 450622, 458431, 1299572,
]

const dungeonSpellIds = [
  217200, 386181, 388651, 377009, 1285508, 1260648, 1246666, 1277556, 1251813, 1264987, 1248879,
  1284954, 1224299, 1215897, 1215157, 1261847, 1264336, 1264246, 1264186, 1276648, 1263000, 1263716,
  153757, 1252691, 1253543, 466559, 465904, 472758, 1219491, 474105, 1253270, 468221, 1283371,
  468429, 1253986,
]

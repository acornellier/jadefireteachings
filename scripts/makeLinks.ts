...
const playerSpellIds = [
  ...
  197895, 388509, 467307, 1239442, 328670, 1268807,
]
...
const dungeonSpellIds = [
  ...
  422969, 429091, 428170, 453458, 427621, 427609, 448492, 448787, 448791, 325209, 274586, 347949,
  350101, 346741, 346947, 1248211, 344874, 319592, 326426, 1240097, 352345, 353635, 350885, 1217439,
  1217316, 1236126, 1227152, 451119, 450860, 431352, 453214, 426735, 426793, 438473, 433781, 433740,
  461507, 439680, 448887, 434093, 434441,
]

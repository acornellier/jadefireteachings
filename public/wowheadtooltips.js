...
WH.fetch = (function () {
  ...
  return function (a, i) {
    ...
    if (
      location.hostname === 'testing.wowhead.com' &&
      new URL(a).hostname.endsWith('.wowhead.com')
    ) {
...
WH.getWowMaxLevel = () => WH.Wow?.getMaxPlayerLevel?.() ?? 80
...
WH.getSpellScalingIndexFromScalingClass = function (e, t) {
  ...
  let a =
    WH.isCataTree() || WH.isMistsTree()
      ? WH.EFFECT_SCALING_CLASS_CATA_ITEM
      : WH.EFFECT_SCALING_CLASS_ITEM
  switch (e) {
...
WH.effectAverage = function (e, t, a, i) {
  ...
  if (o != 0 && s != 0) {
    ...
    if (
      ...
      (r === WH.EFFECT_TYPE_DUMMY ||
        (e['aura'] &&
          (e['aura'][i] === WH.EFFECT_AURA_DUMMY ||
            e['aura'][i] === WH.EFFECT_AURA_PROC_TRIGGER_SPELL ||
            e['aura'][i] === WH.EFFECT_AURA_PERIODIC_DUMMY)))
    ) {
...
WH.getItemSquishEraItemLevel = function (e) {
  if (e > 0) {
    let t = WH.getItemSquishEraCurveIdFromPatch(
      WH.Wow.getVersionStrFromNum(WH.Wow.getVersionString()),
    )
    if (t > 0) {
...
WH.applyStatModifications = function (e, t, a, i, n, s, r, o) {
  ...
  if (
    ...
    (WH.applyStatModifications.ScalingData.AL.length > 1 || A)
  ) {
    ...
    if (c['dps'] || A) {
      ...
      if (A) {
        ...
        if (g[s] && g[s][t]) {
          ...
          B = Math.floor(e * c.speed * (1 + c.dmgrange / 2) + 0.5)
          c['dmgmin1'] = k
          c['dmgmax1'] = B
        }
      } else {
...
WH.setItemModifications = function (e, t, a, i, n, s, r) {
  ...
  if (l.craftingQualityId > 0) {
    e = e.replace(/(<!--rlvl-->\d+<br>)/, function (e, t) {
      let a = WH.ce('img', {
        src:
          `${WH.STATIC_URL}/images/wow/TextureAtlas/${WH.getDataEnvKey()}` +
          '/professions-chaticon-quality-tier' +
          `${l.craftingQualityId}.png`,
        style: 'vertical-align: middle',
      })
      return (
        t + WH.Strings.sprintf(WH.GlobalStrings.PROFESSIONS_CRAFTING_QUALITY, a.outerHTML) + '<br>'
      )
    })
  }
  ...
  e = e.replace(/<!--pvpEquip-->.*?<!--pvpEquip-->/, function () {
    ...
    return (
      '<br><span class="q2">' +
      WH.Strings.sprintf(WH.GlobalStrings.PVP_ITEM_LEVEL_TOOLTIP, l.levelSetPvp) +
      '</span><br><br>'
    )
  })
  ;(function () {
  ...
  while ((R = C.exec(e))) {
    ...
    e = e.replace(
      ...
      '\x3c!--useText:0:' +
        ...
        R[1] +
        '" class="q2"' +
        (t.innerText === '' ? ' style="display:none"' : '') +
        '>$1',
    )
  }
  if (n === 0) {
      ...
      if (this._rppmModList.hasOwnProperty(4)) {
        ...
        if (M.is(':empty')) {
          ...
          for (var O in this._rppmSpecModList) {
            var D = Icon.create(this._rppmSpecModList[O]['filename'], 0, null)
            D.style.display = 'inline-block'
            D.style.verticalAlign = 'middle'
            var N = $('<input name="rppmmod" type="radio" id="rppm-' + O + '" />')
            N.get(0).checked = this._rppmSpecModList[O]['spec'] == -1
            M.append(N)
              .append(this._rppmSpecModList[O]['spec'] == -1 ? '' : D)
              .append(
                '<label for="rppm-' +
                  O +
                  '"> <a>' +
                  (this._rppmSpecModList[O]['spec'] == -1
                    ? WH.TERMS.none
                    : WH.Wow.PlayerClass.Specialization.getName(this._rppmSpecModList[O]['spec'])) +
                  '</a></label>',
              )
              .append('<br />')
            var P = this
          ...
          e = e.replace(/<!--rppm-->(\[?)(\d+(?:\.\d+)?)([^<]*)<!--rppm-->/, function (e, t, a, i) {
            return (
              ...
              (
                ...
                (1 +
                  parseFloat(
                    k[$('input[name="rppmmod"]:checked', M).attr('id').match(/\d+$/)[0]]
                      .modifiervalue,
                  ))
              ).toFixed(2) +
              i +
      ...
      WH.ct(
        ' ' +
          (!WH.isRetailTree() || !o
            ...
            : WH.Strings.sprintf(WH.TERMS.specclass_format, o, WH.Wow.PlayerClass.getName(e))),
      ),
    ),
  )
  if (!n) {
...
WH.updateTooltipCooldownAndCharges = function (e, t) {
  ...
  e = e.replace(
    ...
    `\x3c!--cooldownText--\x3e${a}\x3c!--cooldownText--\x3e`,
  )
  e = e.replace(
    /<!--chargesText-->(.*?)<!--chargesText-->/,
    `\x3c!--chargesText--\x3e${chargesText}\x3c!--chargesText--\x3e`,
  )
  return e
}
...
WH.Tooltips =
  ...
  new (function () {
    ...
    this.parseItemEffectTooltip = function (e, t, a) {
      let i = new RegExp(
        `\x3c!--itemeffect${t}(\\d+):0--\x3e<span(?: hidden.*?)?>(.*?)</span>\x3c!--itemeffect${t}--\x3e(<br>|<br />|</span>)?`,
        'g',
      )
    ...
    function ue(e, t, a) {
      ...
      return (
        ...
        (a.itemRanks ? 'itemRanks' + a.itemRanks : '') +
        ...
        (a.sockets ? 'sockets' + a.sockets.join(',') : '') +
    ...
    function Ye(a, n, r) {
      if (n && a.dataset && a.dataset.simpleTooltip) {
        if (!$ && !a.onmouseout) {
          if (
            a.dataset.tooltipMode
              ? a.dataset.tooltipMode === 'cursor'
              : getComputedStyle(a).display === 'inline'
          ) {
            a.onmousemove = Ne
          }
          a.onmouseout = Pe
    ...
    function Je(e) {
      ...
      z.triggeringElementVisibilityObserver ??= new ResizeObserver(() => {
        if (
          !(z.element.offsetWidth || z.element.offsetHeight || z.element.getClientRects().length)
        ) {
          Ie()
        }
      })
        ...
        if (e.pcs && e.pcs.length) {
          ...
          for (var _ = 0, b = e.pcs.length; _ < b; ++_) {
            ...
            if ((w = s.match(y))) {
              ...
              var A =
                WH.isSet('g_items') && g_items[e.pcs[_]] ? g_items[e.pcs[_]]['name_' + t] : w[4]

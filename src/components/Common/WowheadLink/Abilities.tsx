...
export const CelestialConduit = makeSpell(
  'Celestial Conduit',
  443028,
...
export const CracklingJadeLightning = makeSpell(
...
export const HeartOfTheJadeSerpent = makeSpell(
...
export const JadeEmpowerment = makeSpell(
  'Jade Empowerment',
  467316,
  'ability_monk_cracklingjadelightning',
)
...
export const PurifiedSpirit = makeSpell(
  'Purified Spirit',
  450867,
...
export const SpinningCraneKick = makeSpell(
  'Spinning Crane Kick',
  101546,
  'ability_monk_cranekick_new',
)
export const StrengthOfTheBlackOx = makeSpell(
  'Strength of the Black Ox',
  443110,
  'ability_monk_chargingoxwave',
)
export const TeachingsOfTheMonastery = makeSpell(
  'Teachings of the Monastery',
  116645,
  'passive_monk_teachingsofmonastery',
)
export const TigerPalm = makeSpell('Tiger Palm', 100780, 'ability_monk_tigerpalm')
export const ThunderFocusTea = makeSpell(
  'Thunder Focus Tea',
  116680,
...
export const VivaciousVivification = makeSpell(

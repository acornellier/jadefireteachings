...
export function Introduction() {
  return (
    <div className="section flex flex-col">
      ...
      <p>
        I am Ortemis, and I am usually (when not on vacation) the rank 1 mistweaver in M+. I am also
        the developer of <Link href="https://not-even-close.com/">Not Even Close</Link> and{' '}

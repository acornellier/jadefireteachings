...
export function Conduit() {
  return (
    <SubSection title="Conduit of the Celestials">
      <p>
        The main change from this hero tree is <CelestialConduit />, an extra active healing CD on
        1.5 min CD. This is a powerful cooldown. See{' '}
      ...
      <p>
        ...
        your party. This is not especially strong.
      </p>
      <p>
